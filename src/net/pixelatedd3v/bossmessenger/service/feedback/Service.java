 ...
 */
@WebServiceClient(name = "Service", targetNamespace = "http://pixelatedev.com/bossmessenger/feedback", wsdlLocation = "http://bmfeedback.pixelatedev.com/Services/FeedBackService.asmx?WSDL")
public class Service extends javax.xml.ws.Service {
	...
	private final static QName SERVICE_QNAME = new QName("http://pixelatedev.com/bossmessenger/feedback", "Service");

	static {
		URL url = null;
		WebServiceException e = null;
		try {
			url = new URL("http://bmfeedback.pixelatedev.com/Services/FeedBackService.asmx?WSDL");
	...
	public ServiceSoap getServiceSoap() {
		return super.getPort(new QName("http://pixelatedev.com/bossmessenger/feedback", "ServiceSoap"), ServiceSoap.class);
	}
	...
	public ServiceSoap getServiceSoap(WebServiceFeature... features) {
		return super.getPort(new QName("http://pixelatedev.com/bossmessenger/feedback", "ServiceSoap"), ServiceSoap.class, features);
	}
